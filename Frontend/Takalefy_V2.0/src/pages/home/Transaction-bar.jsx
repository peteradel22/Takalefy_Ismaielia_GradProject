...
const TransactionsPage = () => {
  ...
  const fetchTransactions = useCallback(async () => {
    try {
      ...
      // عرض فقط معاملات النوع "expense"
      const userTransactions = allTransactions.filter(
        (transaction) =>
          transaction.user_id === userId && transaction.type === "expense"
      );
  ...
  const addTransaction = async (newTransaction) => {
    try {
      ...
      // أضف المعاملة الجديدة للحالة المحلية
    ...
    <div className="p-6 bg-gray-100 min-h-screen space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            "https://www.youtube.com/embed/4Eh8QLcB1UQ",
            "https://www.youtube.com/embed/a-vmZpnpze0",
            "https://www.youtube.com/embed/IIKr2915l2g",
            "https://www.youtube.com/embed/8p0xAo-Ismg",
            "https://www.youtube.com/embed/q5zyuvr4Ocs",
            "https://www.youtube.com/embed/GXvzER4VqIY",
            "https://www.youtube.com/embed/a01WCNlckes",
            "https://www.youtube.com/embed/4k0-E8Lnio4",
            "https://www.youtube.com/embed/FzZuw8jwrQs",
          ].map((url, index) => (
