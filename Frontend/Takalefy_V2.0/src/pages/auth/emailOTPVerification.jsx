    ...
    return (
        <div className="font-sans bg-gray-100 flex flex-col justify-center items-center min-h-screen p-4">
            ...
            <div className="text-center mb-4">
                <h1 className="text-xl font-semibold">Enter The Code We Sent to Your Email</h1>
            </div>

            
            <div className="text-center mb-6">
                <p className="text-gray-600">
                    Check your email for an OTP code sent to{' '}
                    <span className="font-bold">saramedhat@gmail.com</span>
                </p>
            </div>
